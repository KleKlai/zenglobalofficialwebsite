...
export default function Hero() {
  return (
    <div className="h-4/5">
      ...
      >
        <div className="absolute lg:inset-0 right-0 w-3/4 bg-gradient-to-r from-white" />
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col space-y-5 text-center lg:text-left">
            <div>
              <h2 className="text-2xl font-semibold tracking-wide text-white lg:text-gray-800">
                internet <br /> essentials
              </h2>
            </div>

            <div>
              <p className="text-4xl font-bold text-white lg:text-gray-800">
                Fast. Reliable. Affordable.
              </p>
            </div>
            <div>
              <p className="text-2xl font-bold text-white lg:text-zinc-800">
                Home internet for Php 599/mo.
              </p>
            </div>
            <div>
              <p className="font-normal text-white lg:text-zinc-800">
            ...
            <div className="lg:w-1/3">
              <p className="text-xs font-normal text-white lg:text-zinc-800">
