  ...
  return (
    <div>
      ...
      <div className="px-72 py-20 flex flex-row space-x-5">
        <PrivacyCard title="Sensitive personal information preferences" href="#" hrefTitle="Review settings">
        ...
        <PrivacyCard title="Cookie preferences" href="#" hrefTitle="Manage cookies">
        ...
        <PrivacyCard title="Download, delete, or correct your information" href="#" hrefTitle="Submit a request">
          Certain states give their residents a legal right to download, delete,
          or correct their personal information, but all Xfinity customers can
          make a request.
        </PrivacyCard>
      </div>
    </div>
